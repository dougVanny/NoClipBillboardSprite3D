...
<img src="docs/HowTo1.svg" alt="drawing" height="300"/>
...
<img src="docs/HowTo2.svg" alt="drawing" height="300"/>
...
Finally, use the pivot field to adjust the position of the sprite without moving the node itself. It is important to keep the node position close to the ground as that's where the shader will position the corner of the L shown in the image above
